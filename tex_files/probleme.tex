...
\begin{description}
    ...
    \item[$\sCCW$] rotation d'un angle $\frac{\pi}{6}$ autour du pivot 
        (Rotation anti-horaire)
    \item[$\sCW$] rotation d'un angle $-\frac{\pi}{6}$ autour du pivot 
        (Rotation horaire)
\end{description}
...
\begin{itemize}
    ...
    \item soit une pièce a été placée deux fois dans la même position.
\end{itemize}
...
\begin{figure}
    \caption{\label{fig:power}Les différentes phrases spéciales et leurs mouvements associés}
    \centering
    \small

    \begin{description}
        \item[{\tt in his house at r'lyeh dead cthulhu waits dreaming.}]
    ...
    \item[{\tt ph'nglui mglw'nafh cthulhu r'lyeh wgah'nagl fhtagn.}] 
    ...
    \item[{\tt case nightmare green}] $\sE\sSW\sCCW\sE\sSE\sSE\sSW\sSW\sSW\sCCW\sSE\sSW\sCW\sE\sSE\sSW\sCW\sE\sE\sSE$
    \item[{\tt cthulhu fhtagn!}] $\sE\sCCW\sSW\sCCW\sSE\sSW\sCCW\sSE\sE\sSW\sCCW\sSW\sSW\sSE\sW$
    \item[{\tt john bigboote}] $\sSW\sSE\sSW\sSE\sSE\sE\sSW\sSW\sE\sSE\sSE\sCCW\sE$ 
    \item[{\tt vigintillion}] $\sCW\sSW\sSW\sSW\sSE\sCCW\sSW\sSE\sSE\sSW\sSE\sSE$ 
    \item[{\tt necronomicon}] $\sSE\sE\sE\sCW\sSE\sSE\sSE\sSE\sSW\sE\sSE\sSE$
    \item[{\tt the laundry}] $\sCCW\sSW\sE\sSE\sSE\sSW\sCCW\sSE\sCW\sCW\sE$
    \item[{\tt yogsothoth}] $\sE\sSE\sSW\sCCW\sSE\sCCW\sSW\sSE\sCCW\sSW$
    \item[{\tt blue hades}] $\sE\sSE\sCCW\sE\sSE\sSW\sSW\sCW\sE\sCCW$
    \item[{\tt tsathoggua}] $\sCCW\sCCW\sSW\sCCW\sSW\sSE\sSW\sSW\sCCW\sSW$
    \item[{\tt monkeyboy}] $\sSE\sSE\sSE\sCCW\sE\sE\sE\sSE\sE$
    \item[{\tt planet 10}] $\sW\sSE\sSW\sSE\sE\sCCW\sSE\sCW\sW$
    \item[{\tt yoyodyne}] $\sE\sSE\sE\sSE\sCW\sE\sSE\sE$
    \item[{\tt ia! ia!}] $\sSW\sSW\sW\sSE\sSW\sSW\sW$
    \item[{\tt yuggoth}] $\sE\sCCW\sSW\sSW\sSE\sCCW\sSW$
    \item[{\tt r'lyeh}] $\sCW\sW\sSE\sE\sE\sSW$
    \item[{\tt ei!}] $\sE\sSW\sW$
\end{description}
\end{figure}
